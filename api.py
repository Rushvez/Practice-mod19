...
class PetFriends:
    ...
    def create_pet_simple(self, auth_key: json, name: str,
        ...
        """Метод отправляет на сервер данные о добавляемом питомце c минимальными данными без фотографии
    ...
    def add_photo_of_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод добавляет фотографию питомца на сервер и возвращает
